...
var validateAppInTossPluginOptions = (() => {
  ...
  const _io8 = (input) => (void 0 === input.withBackButton || "boolean" === typeof input.withBackButton) && (void 0 === input.withHomeButton || "boolean" === typeof input.withHomeButton) && (void 0 === input.withTitle || "boolean" === typeof input.withTitle) && (void 0 === input.transparentBackground || "boolean" === typeof input.transparentBackground) && (void 0 === input.theme || "light" === input.theme || "dark" === input.theme) && (void 0 === input.initialAccessoryButton || "object" === typeof input.initialAccessoryButton && null !== input.initialAccessoryButton && _io9(input.initialAccessoryButton));
