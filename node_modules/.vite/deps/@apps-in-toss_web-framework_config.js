...
// node_modules/@apps-in-toss/web-framework/dist/config/index.js
...
var validateAppInTossWebPluginOptions = (() => {
  ...
  const _io3 = (input) => (void 0 === input.withBackButton || "boolean" === typeof input.withBackButton) && (void 0 === input.withHomeButton || "boolean" === typeof input.withHomeButton) && (void 0 === input.withTitle || "boolean" === typeof input.withTitle) && (void 0 === input.transparentBackground || "boolean" === typeof input.transparentBackground) && (void 0 === input.theme || "light" === input.theme || "dark" === input.theme) && (void 0 === input.initialAccessoryButton || "object" === typeof input.initialAccessoryButton && null !== input.initialAccessoryButton && _io4(input.initialAccessoryButton));
  ...
  }), void 0 === input.withTitle || "boolean" === typeof input.withTitle || _report(_exceptionable, {
    path: _path + ".withTitle",
    expected: "(boolean | undefined)",
    value: input.withTitle
...
//# sourceMappingURL=@apps-in-toss_web-framework_config.js.map
