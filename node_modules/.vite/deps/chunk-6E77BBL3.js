...
var getConsentedUserData = createAsyncBridge("getConsentedUserData");
var requestReview = createAsyncBridge("requestReview");
var getDeclaredAgeRange = createAsyncBridge("getDeclaredAgeRange");
...
function trackResponseError(response, adGroupId, context) {
  ...
  if (response.resultType !== "SUCCESS") {
    trackBannerError({
      ...
      errorMessage: ((_a = response.error) == null ? void 0 : _a.reason) ?? response.resultType
    });
    return;
  }
...
async function fireResultTracking(response, adGroupId, ctx) {
  var _a, _b;
  const status = (_a = response.success) == null ? void 0 : _a.status;
  ...
  const body = {
    ...
    requestId: ((_b = response.success) == null ? void 0 : _b.requestId) ?? "",
...
function extractAdTrackingContext(response) {
  var _a, _b, _c, _d, _e;
  const mediation = (_a = response == null ? void 0 : response.ext) == null ? void 0 : _a.mediation;
  return {
    mediationId: nonEmptyString(mediation == null ? void 0 : mediation.mediationId),
    eventContextToken: nonEmptyString(response == null ? void 0 : response.eventContextToken),
    resultEndpoint: nonEmptyString((_b = mediation == null ? void 0 : mediation.endpoint) == null ? void 0 : _b.result),
    errorEndpoint: nonEmptyString((_c = mediation == null ? void 0 : mediation.endpoint) == null ? void 0 : _c.error),
    adUnitId: nonEmptyString((_d = mediation == null ? void 0 : mediation.admob) == null ? void 0 : _d.adUnitId),
    placementId: typeof ((_e = mediation == null ? void 0 : mediation.admob) == null ? void 0 : _e.placementId) === "number" ? mediation.admob.placementId : void 0
  };
}
var fetchTossAd = Object.assign(createEventBridge2("fetchTossAd"), {
  isSupported: createConstantBridge2("fetchTossAd_isSupported")
});
var fetchAppsInTossAd = Object.assign(createEventBridge2("fetchAppsInTossAd"), {
  isSupported: createConstantBridge2("fetchAppsInTossAd_isSupported")
});
var getPlatformOS2 = createConstantBridge2("getPlatformOS");
var getTossAppVersion2 = createConstantBridge2("getTossAppVersion");
var WEB_SDK_ID = "108";
...
function getSubBundle() {
  var _a, _b;
  return ((_b = (_a = globalThis.__granite) == null ? void 0 : _a.app) == null ? void 0 : _b.name) ?? "";
}
...
var getDeclaredAgeRange2 = Object.assign(
...
export {
  ...
  getDeclaredAgeRange2 as getDeclaredAgeRange,
  Analytics
};
//# sourceMappingURL=chunk-6E77BBL3.js.map
