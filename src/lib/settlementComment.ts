...
const COMMENT_TEMPLATES: readonly CommentTemplate[] = [
  {
    ...
    closings: [
      ...
      "그래도 레일은 내일도 돌아갑니다. 다음 근무에서는 클레임을 피해보세요",
  ...
  },
  {
    ...
    closings: ["오늘의 경험은 내일의 콤보가 됩니다.", "다음 성과급 상자는 조금 더 욕심내도 좋겠습니다.", "첫 월급은 작았지만 다음 근무는 다를지도 모릅니다."],
  },
  {
  ...
  },
  {
    ...
    closings: ["다음 근무에서는 마트의 핵심 인력이 될 수 있겠습니다.", "높은 단가의 마지막 스테이지가 당신을 기다립니다.", "이 페이스라면 다음 근무에는 성과급 상자가 당신을 먼저 알아볼지도 모릅니다."],
  },
  {
